...
public class App
{
    public static void main( String[] args )
    {
        ...
        phoneDAO.add(new Phone("iPhone 11 Pro Max", 12000, "Deep Purple", "VN", 10));
        phoneDAO.add(new Phone("iPhone 12 Pro Max", 13000, "Deep Blue", "VN", 50));
        phoneDAO.add(new Phone("iPhone 13 Pro Max", 16000000, "Pink", "USB", 1));
        //lay phone co id=1
